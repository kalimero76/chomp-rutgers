...
/* C++ doesn't allow templated typedef's yet. This is a workaround. 
...
/** Dense_Matrix_Boundary_Map creates a representation of the boundary map \f$\partial_k : C_k \rightarrow C_{k-1}\f$. 
 * The output is returned in "output_matrix",
