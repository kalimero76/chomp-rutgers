...
void test_example ( void ) {
  ...
  Subcomplex < Cubical_Complex > my_subcomplex ( my_cubical_complex );
...
#if 0
  my_subcomplex . Remove_Cell ( * my_subcomplex . cells[3] . begin () );	
	Morse_Complex < Subcomplex < Cubical_Complex > > my_morse_complex ( my_subcomplex );
#else
