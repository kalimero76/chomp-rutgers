...
namespace morse_detail {
	...
	return morse_complex . husband_pointers [ *input ]; } /* endfunction */
	...
	return morse_complex . morse_values [ *input ]; } /* endfunction */
	...
	return morse_complex . flags [ *input ]; } /* endfunction */
