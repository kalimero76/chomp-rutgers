...
template < class Cell_Complex >
Morse_Complex<Cell_Complex>::Morse_Complex ( const Cell_Complex & cell_complex ) : Cell_Complex(cell_complex) {
  /* TODO: ONCE INDEXING CAPABLE, GET RID OF THIS. */
...
Morse_Complex<Cell_Complex>::husband ( const const_iterator & input ) {
  return husband_ [ index_ [ input ] ];
} /* Morse_Complex<>::husband */

template < class Cell_Complex > unsigned int & 
Morse_Complex<Cell_Complex>::value ( const const_iterator & input ) {
  return value_ [ index_ [ input ] ];
} /* Morse_Complex<>::value */

template < class Cell_Complex > unsigned char & 
Morse_Complex<Cell_Complex>::flags ( const const_iterator & input ) {
